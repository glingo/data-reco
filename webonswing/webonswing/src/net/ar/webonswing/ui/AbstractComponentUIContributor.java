...
public abstract class AbstractComponentUIContributor implements ComponentUIContributor
{
	protected VisualComponent theComponent;
	...
	{
		ContributorVisitor theContribVisitor= (ContributorVisitor) aVisitor;
		theContribVisitor.visitRenderingContributor(this);
	}
