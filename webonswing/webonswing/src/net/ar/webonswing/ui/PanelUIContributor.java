...
public class PanelUIContributor extends AbstractSwingComponentUIContributor 
{
	public void doRenderingContribution(RenderingContributionContainer theRenderingContribManager)
	{
		JComponent aPanel= getJComponent();

		Template theTemplate= aPanel.getLayout() instanceof TemplateLayout ? ((TemplateLayout) aPanel.getLayout()).getTemplate() : new HtmlDivsTemplate();

		Component[] theComponents= aPanel.getComponents();
