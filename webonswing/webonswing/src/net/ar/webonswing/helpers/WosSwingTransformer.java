...
public class WosSwingTransformer extends EmptyVisitor
{
	public static String MY_PACKAGE_PATH= updatePackage("swingwos");
	...
	public WosSwingTransformer(String aPackage)
	{
	...
	{
		return WosClassLoader.getInstance().loadClass(transformSwingClassName(aString));
	}
