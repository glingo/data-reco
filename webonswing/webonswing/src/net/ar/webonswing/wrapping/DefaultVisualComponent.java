...
public class DefaultVisualComponent extends AbstractVisualComponent 
{
	private Rectangle theBounds;
	protected Hashtable theClienteProps= new Hashtable();
	...
	{
		theClienteProps.put(aKey, aValue);
	}

	public Object getClientProperty(Object aKey)
	{
		return theClienteProps.get(aKey);
	}
}
