...
function JRequiredFieldValidator(aValidatorName, aComponentToValidate, anOwnMessage, aGroupMessage, isGrouped, shooters)
{
	...
	this.doValidation= function()
	{
		...
		{
			this.isValid= this.getComponentValue(aComponentToValidate).length != 0;
