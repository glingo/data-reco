...
public class DefaultPage implements Page
{
	...
	public DefaultPage(VisualWindow aWindow)
	{
		setWindow(aWindow);
	}

	public VisualWindow getWindow()
	{
		return theWindow;
	}

	public void setWindow(VisualWindow window)
	{
		theWindow= window;
	}

	public void setWindowClassName(String aWindowClassName)
	{
