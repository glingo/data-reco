...
public class PersistenceManagerPage extends DefaultHtmlPage
{
	public void prepareResponse(HttpServletResponse aResponse) throws Exception
	{
		...
		theContributionContainer.getScriptManager().addInclude(WosFramework.getInstance().getCompleteResourcePath() + "/js/PersistenceManager.js");
