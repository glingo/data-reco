...
public class LabelContributor extends AbstractComponentUIContributor
{
	public void doRenderingContribution(RenderingContributionContainer aRenderingContribManager)
	{
		aRenderingContribManager.doContribution(theComponent, new Tag("a").addTextToContainer(((Label)theComponent).getText()), null, "");
	}
}
