...
public class IntVecteur extends Vecteur<Integer> {
	...
	/**
	 * Le produit vectoriel sert à calculer le IntegerVecteur perpendiculaire à deux autres IntegerVecteurs. 
	 * Le produit vectoriel se dit cross product (produit croisé) en anglais.
	 * Le calcul du produit vectoriel se fait à partir de deux IntegerVecteurs et permet d'obtenir un autre IntegerVecteur. 
	 * Ce IntegerVecteur obtenu est perpendiculaire aux deux autres IntegerVecteurs... 
	...
	public IntVecteur cross(IVecteur<Integer> v) {
		...
		if ((this.getDimension() != 3) || (v.getDimension() != 3))
			...
			"Le cross product ne peut être effectuée que si les deux IntegerVecteurs sont de dimensions 3");
	...
	public static int dot(IntVecteur a, IntVecteur b) {
		...
		if(a.getDimension() != b.getDimension())
			throw new DimensionException(
			"Le produit scalaire ne peut être effectuée que si les deux IntegerVecteurs ont les mêmes dimensions");
	...
	/**
	 * Notez que si vous échangez les IntegerVecteurs a et b dans les calculs, 
	 * le IntegerVecteur obtenu sera exactement le IntegerVecteur opposé à celui que vous auriez obtenu sans échanger a et b.
	 * @param a
	 * @param b
	 * @return
	 */
	public static IntVecteur cross(IntVecteur a, IntVecteur b) {
		...
		if(a.getDimension() != b.getDimension())
			throw new DimensionException(
			"La multiplication ne peut être effectuée que si les deux IntegerVecteurs ont les mêmes dimensions");
	...
	public static IntVecteur add(IntVecteur a, IntVecteur b) {
		...
		if(a.getDimension() != b.getDimension())
			throw new DimensionException(
			"L'addition ne peut être effectuée que si les deux IntegerVecteurs ont les mêmes dimensions");
	...
	public static IntVecteur sub(IntVecteur a, IntVecteur b) {
		...
		if(a.getDimension() != b.getDimension())
			throw new DimensionException(
			"La substraction ne peut être effectuée que si les deux IntegerVecteurs ont les mêmes dimensions");
