...
public class FloatVecteur extends Vecteur<Float> {
	...
	/**
	 * Le produit vectoriel sert � calculer le FloatVecteur perpendiculaire � deux autres FloatVecteurs. 
	 * Le produit vectoriel se dit cross product (produit crois�) en anglais.
	 * Le calcul du produit vectoriel se fait � partir de deux FloatVecteurs et permet d'obtenir un autre FloatVecteur. 
	...
	/**
	 * Notez que si vous �changez les FloatVecteurs a et b dans les calculs, 
	 * le FloatVecteur obtenu sera exactement le FloatVecteur oppos� � celui que vous auriez obtenu sans �changer a et b.
	 * @param a
	 * @param b
	 * @return
	 */
