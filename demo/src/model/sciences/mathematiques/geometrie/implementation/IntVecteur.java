...
import model.sciences.mathematiques.IMatrice;
import model.sciences.mathematiques.IVecteur;
import model.sciences.mathematiques.Vecteur;
import model.sciences.mathematiques.geometrie.exceptions.DimensionException;
...
public class IntVecteur extends Vecteur<Integer> {
	...
	/**
	 * Le produit vectoriel sert � calculer le IntegerVecteur perpendiculaire � deux autres IntegerVecteurs. 
	 * Le produit vectoriel se dit cross product (produit crois�) en anglais.
	 * Le calcul du produit vectoriel se fait � partir de deux IntegerVecteurs et permet d'obtenir un autre IntegerVecteur. 
	 * Ce IntegerVecteur obtenu est perpendiculaire aux deux autres IntegerVecteurs... 
	 * tout comme la normale d'une face est perpendiculaire � la face elle m�me.
	 */
	@Override
	 ...
	 * le IntegerVecteur obtenu sera exactement le IntegerVecteur oppos� � celui que vous auriez obtenu sans �changer a et b.
	 * @param a
	 * @param b
	 * @return
	 */
